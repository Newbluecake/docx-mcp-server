import pytest
import json
from docx_mcp_server.server import docx_insert_paragraph, docx_insert_run, docx_set_font, docx_copy_paragraph, docx_get_element_source, docx_insert_heading
