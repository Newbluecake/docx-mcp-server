#!/usr/bin/env python3
"""Batch update script for second batch of test files."""
...
def update_imports(content):
    ...
    # Check if it's in tools/ subdirectory
    is_tools_subdir = 'tools/test_' in str(content) or 'test_copy_tools' in content or 'test_image_position' in content
...
def main():
    ...
    # Second batch files
    files = [
        test_dir / 'unit' / 'test_cursor_advanced_tools_json.py',
        test_dir / 'unit' / 'tools' / 'test_copy_tools.py',
        test_dir / 'unit' / 'tools' / 'test_image_position.py',
        test_dir / 'unit' / 'tools' / 'test_paragraph_position.py',
        test_dir / 'unit' / 'tools' / 'test_table_position.py',
    ]

    print("🔧 Batch updating second batch of test files...")
    print()
